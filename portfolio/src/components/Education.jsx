...
const education = [
    ...
    },
    {
        ...
        institution: 'Neelkanth Institute of Technology, Meerut',
        year: '2020 - 2023',
        grade: 'Percentage: 75%',
...
const EducationCard = ({ edu, index }) => {
    return (
        ...
        >
            ...
            >
                <div className="relative z-10 flex flex-col sm:flex-row gap-3 items-start justify-between">
...
const Education = () => {
    ...
    return (
        <section className="w-full py-20 bg-dark relative overflow-hidden" id="education" ref={containerRef}>
            <Particles />
