    ...
    return (
        ...
        >
            ...
            <span className="absolute left-[-5px] top-5 w-4 h-4 z-20">
                <motion.span
                    className={`absolute inset-0 rounded-full bg-gradient-to-r ${cert.color}`}
                ...
                <motion.div
                    ...
                    className={`relative w-4 h-4 rounded-full bg-gradient-to-r ${cert.color} shadow-[0_0_12px_rgba(56,189,248,0.8)] border-2 border-dark`}
                />
            </span>
